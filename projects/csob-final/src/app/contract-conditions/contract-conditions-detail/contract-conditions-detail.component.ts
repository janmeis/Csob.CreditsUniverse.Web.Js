...
import { ECodetable, EFinancialConditionOperator, EFrequencyUnit, ERecurrenceType, ICodebookItem, IContractConditionDto, IContractConditionEditDto, IContractConditionRuleEditDto, IFinancialCovenantDto, IPartyHeaderDto } from 'src/app/services/webapi/webapi-models';
